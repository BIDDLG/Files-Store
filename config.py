...
SHORTLINK_URL = environ.get("SHORTLINK_URL", "api.gplinks.com") # shortlink domain without https://
SHORTLINK_API = environ.get("SHORTLINK_API", "2469484d258897da1dc9edaf4face6f466301f39") # shortlink api
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://herokuapp.com/")
